...
namespace restfulEz {
    ...
    QUERY_FORM QUERY_FORM::make_form_LOL(const int end_name, const int endpoint_method) {
        // purely for readability
        switch (end_name) {
            case CHAMPION_MASTERY:
                switch (endpoint_method) {
                    case CM_BY_PUUID:
                        return QUERY_FORM(2, LOL, CHAMPION_MASTERY, CM_BY_PUUID, "League of Legends", "Champion Mastery", "By Summoner Id", {"Routing","Summoner ID"},{_NO_FLAG,_NO_FLAG}); break;
                    case CM_BY_RIOT_ID:
                        return QUERY_FORM(3, LOL, CHAMPION_MASTERY, CM_BY_RIOT_ID, "League of Legends", "Champion Mastery", "By Summoner By Champion", {"Routing", "Summoner ID", "Champion ID"},{_NO_FLAG,_NO_FLAG,_DEC_FLAG}); break;
                    case CM_BY_GAME_BY_PUUID:
                        return QUERY_FORM(2, LOL, CHAMPION_MASTERY, CM_BY_GAME_BY_PUUID, "League of Legends", "Champion Mastery", "Top By Summoner", {"Routing", "Summoner ID"}, {_NO_FLAG, _NO_FLAG}, true, {"count"}, {"3"}, {_DEC_FLAG}); break;
                    case CM_SCORE_BY_SUMMONER:
                        return QUERY_FORM(2, LOL, CHAMPION_MASTERY, CM_SCORE_BY_SUMMONER, "League of Legends", "Champion Mastery", "Score By Summoner", {"Routing", "Summoner ID"}, {_NO_FLAG, _NO_FLAG}); break;
                } break;
            case CHAMPION_ROTATION:
                switch (endpoint_method) {
                    case CR_ROTATION:
                        return QUERY_FORM(1, LOL, CHAMPION_ROTATION, CR_ROTATION, "League of Legends", "Champion_Rotation", "Rotation", {"Routing"}, {_NO_FLAG}); break;
                } break;
            case CLASH:
                switch (endpoint_method) {
                    case CL_BY_SUMMONER_ID:
                        return QUERY_FORM(2, LOL, CLASH, CL_BY_SUMMONER_ID, "League of Legends", "Clash", "By Summoner Id", {"Routing", "Summoner Id"}, {_NO_FLAG, _NO_FLAG}); break;
                    case CL_BY_TEAM:
                        return QUERY_FORM(2, LOL, CLASH, CL_BY_TEAM, "League of Legends", "Clash", "By Team", {"Routing", "Team"}, {_NO_FLAG, _NO_FLAG}); break;
                    case CL_TOURNAMENT_BY_TEAM:
                        return QUERY_FORM(2, LOL, CLASH, CL_TOURNAMENT_BY_TEAM, "League of Legends", "Clash", "Tournament By Team", {"Routing", "Team"}, {_NO_FLAG, _NO_FLAG}); break;
                    case CL_BY_TOURNAMENT:
                        return QUERY_FORM(2, LOL, CLASH, CL_BY_TOURNAMENT, "League of Legends", "Clash", "By Tourament", {"Routing", "Tourament"}, {_NO_FLAG, _NO_FLAG}); break;
                } break;
            case LEAGUE:
                switch (endpoint_method) {
                    case CHALLENGER:
                        return QUERY_FORM(2, LOL, LEAGUE, CHALLENGER, "League of Legends", "League", "Challenger", {"Routing", "Queue"}, {_NO_FLAG, _NO_FLAG}); break;
                    case GRANDMASTER:
                        return QUERY_FORM(2, LOL, LEAGUE, GRANDMASTER, "League of Legends", "League", "Grandmaster", {"Routing", "Queue"}, {_NO_FLAG, _NO_FLAG}); break;
                    case MASTER:
                        return QUERY_FORM(2, LOL, LEAGUE, MASTER, "League of Legends", "League", "Master", {"Routing", "Queue"}, {_NO_FLAG, _NO_FLAG}); break;
                    case L_BY_SUMMONER_ID:
                        return QUERY_FORM(2, LOL, LEAGUE, L_BY_SUMMONER_ID, "League of Legends", "League", "By Summoner ID", {"Routing", "Summoner ID"}, {_NO_FLAG, _NO_FLAG}); break;
                    case L_BY_LEAGUE_ID:
                        return QUERY_FORM(2, LOL, LEAGUE, L_BY_LEAGUE_ID, "League of Legends", "League", "By League ID", {"Routing", "League ID"}, {_NO_FLAG, _NO_FLAG}); break;
                    case L_SPECIFIC_LEAGUE:
                        return QUERY_FORM(4, LOL, LEAGUE, L_SPECIFIC_LEAGUE, "League of Legends", "League", "Specific League", {"Routing", "Queue", "Tier", "Division"}, {_NO_FLAG, _NO_FLAG, _NO_FLAG, _NO_FLAG}, true, {"page"}, {"1"}, {_DEC_FLAG}); break;
                    case L_EXPERIMENTAL:
                        return QUERY_FORM(4, LOL, LEAGUE, L_EXPERIMENTAL, "League of Legends", "League", "Experimental", {"Routing", "Queue", "Tier", "Division"}, {_NO_FLAG, _NO_FLAG, _NO_FLAG, _NO_FLAG}, true, {"page"}, {"1"}, {_DEC_FLAG}); break;
                } break;
            case CHALLENGES:
                switch (endpoint_method) {
                    case CH_CONFIGURATION:
                        return QUERY_FORM(1, LOL, CHALLENGES, CH_CONFIGURATION, "League of Legends", "Challenges", "Configuration", {"Routing"}, {_NO_FLAG}); break;
                    case CH_PERCENTILES:
                        return QUERY_FORM(1, LOL, CHALLENGES, CH_PERCENTILES, "League of Legends", "Challenges", "Percentiles", {"Routing"}, {_NO_FLAG}); break;
                    case CH_CH_CONFIGURATION:
                        return QUERY_FORM(2, LOL, CHALLENGES, CH_CH_CONFIGURATION, "League of Legends", "Challenges", "Challenge Configuration", {"Routing", "Challenge ID"}, {_NO_FLAG, _DEC_FLAG}); break;
                    case CH_CH_LEADERBOARD:
                        return QUERY_FORM(3, LOL, CHALLENGES, CH_CH_LEADERBOARD, "League of Legends", "Challenges", "Challenge Leaderboards", {"Routing", "Challenge ID", "Level"}, {_NO_FLAG, _DEC_FLAG, _NO_FLAG}, true, {"limit"}, {""}, {_DEC_FLAG}); break;
                    case CH_CH_PERCENTILES:
                        return QUERY_FORM(2, LOL, CHALLENGES, CH_CH_PERCENTILES, "League of Legends", "Challenges", "Challenge Percentiles", {"Routing", "Challenge ID"}, {_NO_FLAG, _DEC_FLAG}); break;
                    case CH_BY_PUUID:
                        return QUERY_FORM(2, LOL, CHALLENGES, CH_BY_PUUID, "League of Legends", "Challenges", "By Puuid", {"Routing", "PUUID"}, {_NO_FLAG, _NO_FLAG}); break;
                } break;
            case STATUS:
                switch (endpoint_method) {
                    case V4:
                        return QUERY_FORM(1, LOL, STATUS, V4, "League of Legends", "Status", "Default (v4)", {"Routing"}, {_NO_FLAG}); break;
                    case V3:
                        return QUERY_FORM(1, LOL, STATUS, V3, "League of Legends", "Status", "v3", {"Routing"}, {_NO_FLAG}); break;
                } break;
            case MATCH:
                switch (endpoint_method) {
                    case M_BY_MATCH_ID:
                        return QUERY_FORM(2, LOL, MATCH, M_BY_MATCH_ID, "League of Legends", "Match", "By Match ID", {"Routing", "Match ID"}, {_NO_FLAG, _NO_FLAG }); break;
                    case M_TIMELINE:
                        return QUERY_FORM(2, LOL, MATCH, M_TIMELINE, "League of Legends", "Match", "Timeline", {"Routing", "Match ID"}, {_NO_FLAG, _NO_FLAG}); break;
                    case M_BY_PUUID:
                        return QUERY_FORM(2, LOL, MATCH, M_BY_PUUID, "League of Legends", "Match", "By Puuid", {"Routing", "PUUID"}, {_NO_FLAG, _NO_FLAG}, true, {"startTime", "endTime", "queue", "type", "start", "count"}, {"", "", "", "", "0", "20"}, {_DEC_FLAG, _DEC_FLAG, _DEC_FLAG, _NO_FLAG, _DEC_FLAG, _DEC_FLAG}); break;
                } break;
            case SUMMONER:
                switch (endpoint_method) {
                    case S_BY_RSO_PUUID:
                        return QUERY_FORM(2, LOL, SUMMONER, S_BY_RSO_PUUID, "League of Legends", "Summoner", "By RSO Puuid", {"Routing", "RSO PUUID"}, {_NO_FLAG, _NO_FLAG}); break;
                    case S_BY_ACCOUNT_ID:
                        return QUERY_FORM(2, LOL, SUMMONER, S_BY_ACCOUNT_ID, "League of Legends", "Summoner", "By Account ID", {"Routing", "Account ID"}, {_NO_FLAG, _NO_FLAG}); break;
                    case S_BY_NAME:
                        return QUERY_FORM(2, LOL, SUMMONER, S_BY_NAME, "League of Legends", "Summoner", "By Name", {"Routing", "Name"}, {_NO_FLAG, _NO_FLAG}); break;
                    case S_BY_PUUID:
                        return QUERY_FORM(2, LOL, SUMMONER, S_BY_PUUID, "League of Legends", "Summoner", "By Puuid", {"Routing", "PUUID"}, {_NO_FLAG, _NO_FLAG}); break;
                    case S_BY_SUMMONER_ID:
                        return QUERY_FORM(2, LOL, SUMMONER, S_BY_SUMMONER_ID, "League of Legends", "Summoner", "By Summoner ID", {"Routing", "Summoner ID"}, {_NO_FLAG, _NO_FLAG }); break;
                } break;
            case SPECTATOR:
                switch (endpoint_method) {
                    case SP_BY_SUMMONER_ID:
                        return QUERY_FORM(2, LOL, SPECTATOR, SP_BY_SUMMONER_ID, "League of Legends", "Spectator", "By Summoner Id", {"Routing", "Summoner ID"}, {_NO_FLAG, _NO_FLAG }); break;
                    case SP_FEATURED:
                        return QUERY_FORM(1, LOL, SPECTATOR, SP_FEATURED, "League of Legends", "Spectator", "Featured Games", {"Routing"}, {_NO_FLAG}); break;
                } break;
        };
